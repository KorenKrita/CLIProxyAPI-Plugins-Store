  ...
  "plugins": [
    {
      "id": "qoder",
      "name": "Qoder Provider",
      "description": "Adds Qoder provider support.",
      "author": "author-name",
      "version": "0.1.0",
      "repository": "https://github.com/author-name/cliproxy-qoder-plugin",
      "logo": "https://raw.githubusercontent.com/author-name/cliproxy-qoder-plugin/main/logo.png",
      "homepage": "https://github.com/author-name/cliproxy-qoder-plugin",
      "license": "MIT",
      "tags": ["provider"]
    }
  ]
...
```text
qoder_0.1.0_darwin_arm64.zip
qoder_0.1.0_linux_amd64.zip
qoder_0.1.0_windows_amd64.zip
checksums.txt
```
...
```text
<sha256>  qoder_0.1.0_darwin_arm64.zip
```
